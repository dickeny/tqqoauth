 ...
 *
 * The first PHP Library to support OAuth for Tqq's REST API.
 */
...
class TqqOAuth {
  ...
  public $http_info;
  /* Set the useragnet. */
  public $useragent = 'TqqOAuth v0.2.0-beta2';
   ...
   * @returns a string
   */
  function getAuthorizeURL($token, $sign_in_with_tqq = TRUE) {
    if (is_array($token)) {
      $token = $token['oauth_token'];
    }
    if (empty($sign_in_with_tqq)) {
